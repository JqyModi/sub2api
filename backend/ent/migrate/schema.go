...
var (
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "description_en", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
		...
		{Name: "features_en", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
		{Name: "product_name", Type: field.TypeString, Size: 100, Default: ""},
		{Name: "for_sale", Type: field.TypeBool, Default: true},
		{Name: "max_sales", Type: field.TypeInt, Default: 0},
