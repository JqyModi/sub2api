export default {
  ...
  payment: {
    ...
    methods: {
      ...
      wxpay: 'WeChat Pay',
      stripe: 'Stripe',
      stripe_card: 'International Card',
      airwallex: 'Airwallex',
      card: 'Card',
      link: 'Link',
    ...
    planCard: {
      soldOut: 'Sold out',
      remainingSales: '{count} remaining',
      rate: 'Rate',
      peakRate: 'Peak Rate',
      dailyLimit: 'Daily',
      weeklyLimit: 'Weekly',
    ...
    admin: {
      ...
      planDescriptionEn: 'Plan Description (English)',
      translationFallbackHint: 'English pages fall back to the default content when the English translation is empty.',
      ...
      growthFunnel: 'Subscription conversion funnel',
      growthFunnelHint: 'Anonymous desktop events combined with account, order, and subscription usage data for the selected period.',
      funnelStages: {
        announcement_viewed: 'Announcement views',
        announcement_clicked: 'Announcement clicks',
        desktop_auth_started: 'Authorization starts',
        registration_completed: 'New registrations',
        trial_activated: 'Trial subscriptions granted',
        checkout_started: 'Checkout users',
        payment_completed: 'Paid users',
        referral_reward_granted: 'Referral rewards granted',
        first_api_request_succeeded: 'Active users',
      },
      daySuffix: 'd',
      ...
      unlimited: 'Unlimited',
      maxSales: 'Total sales limit',
      perUserLimit: 'Per-user purchase limit',
      zeroMeansUnlimited: '0 means unlimited',
      salesLimit: 'Sales',
      perUserLimitValue: 'Per user: {count}',
