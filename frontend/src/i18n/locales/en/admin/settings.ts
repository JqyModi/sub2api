export default {
    settings: {
      ...
      payment: {
        ...
        providerStripeCard: 'Stripe international cards (USD)',
        ...
        field_stripeCardCurrencyHint: 'The international card route is fixed to USD; configure WeChat Pay and Alipay on a CNY route.',
        ...
        stripeCnyRouteHint: 'Use this Stripe instance for CNY wallet payments only. Enable WeChat Pay or Alipay here, and create a separate Stripe international cards (USD) instance for card payments.',
