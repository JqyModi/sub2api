export default {
    settings: {
      ...
      payment: {
        ...
        providerStripeCard: 'Stripe 国际银行卡（USD）',
        ...
        field_stripeCardCurrencyHint: '国际银行卡入口固定使用 USD；微信和支付宝请配置到 CNY 通道。',
        ...
        stripeCnyRouteHint: '该 Stripe 实例用于 CNY 钱包支付。请只启用微信支付或支付宝；国际银行卡请单独创建“Stripe 国际银行卡（USD）”实例。',
