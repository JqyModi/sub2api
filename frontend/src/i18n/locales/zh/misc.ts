export default {
  ...
  payment: {
    ...
    errors: {
      ...
      REFUND_FAILED: '退款失败',
      PLAN_SOLD_OUT: '该套餐已售罄',
      PLAN_PURCHASE_LIMIT_REACHED: '您已达到该套餐的购买次数上限',
    },
    ...
    admin: {
      ...
      planDescriptionEn: '套餐描述（英文）',
      translationFallbackHint: '英文内容留空时，英文界面将回退显示中文内容。',
      createPlan: '创建套餐',
      editPlan: '编辑套餐',
      deletePlan: '删除套餐',
      ...
      featuresPlaceholderEn: 'Enter plan features in English...',
      ...
      growthFunnel: '订阅转化漏斗',
      growthFunnelHint: '所选周期内的匿名桌面事件，以及账号、订单和订阅用量业务数据。',
      funnelStages: {
        announcement_viewed: '公告曝光',
        announcement_clicked: '公告点击',
        desktop_auth_started: '发起授权',
        registration_completed: '新增注册',
        trial_activated: '试用已发放',
        checkout_started: '发起结账用户',
        payment_completed: '支付用户',
        referral_reward_granted: '邀请奖励已发放',
        first_api_request_succeeded: '实际使用用户',
      },
      daySuffix: '天',
      ...
      maxSales: '总销量上限',
      perUserLimit: '单用户限购',
      zeroMeansUnlimited: '填写 0 表示不限制',
      salesLimit: '销量限制',
      perUserLimitValue: '每位用户限购 {count} 份',
