            ...
            <template v-if="selectedPlan">
              <div class="card p-5">
                ...
                <div class="mb-3 flex flex-wrap items-center gap-2">
                  ...
                  <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ selectedPlanContent.name }}</h3>
                </div>
                <!-- Price -->
                ...
                <!-- Description -->
                <p v-if="selectedPlanContent.description" class="mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                  ...
                  <div v-for="sub in activeSubscriptions" :key="sub.id"
                    ...
                    <div class="min-w-0 flex-1">
                      <div class="flex items-center gap-1.5">
                        <span class="truncate text-xs font-semibold text-gray-900 dark:text-white">{{ activeSubscriptionDisplayName(sub) }}</span>
...
import type { SubscriptionPlan, SubscriptionPlanCatalogItem, CheckoutInfoResponse, CreateOrderResult, OrderType } from '@/types/payment'
...
import { localizedPlanContent, localizedPlanContentForGroup } from '@/components/payment/localizedPlanContent'
...
function activeSubscriptionDisplayName(sub: { group_id: number; group?: { name?: string } | null }): string {
  return localizedPlanContentForGroup(planCatalog.value, sub.group_id, String(i18n.locale.value))?.name
    || sub.group?.name
...
const selectedPlanContent = computed(() => selectedPlan.value
  ? localizedPlanContent(selectedPlan.value, String(i18n.locale.value))
