    ...
    <div class="space-y-6">
      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div v-if="hasCashRebate" class="card p-5">
          ...
          <div v-if="hasCashRebate || detail.aff_quota > 0 || detail.aff_history_quota > 0" class="card p-5">
        ...
        <div class="card p-6">
          ...
          <div class="mt-5 rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/40 dark:bg-primary-900/20">
            ...
            <ul class="mt-2 space-y-1 text-sm text-primary-700 dark:text-primary-300">
              ...
              <li v-if="hasCashRebate">2. {{ t('affiliate.tips.line2', { rate: `${formattedRebateRate}%` }) }}</li>
              <li v-if="hasCashRebate">3. {{ t('affiliate.tips.line3') }}</li>
              <li>{{ hasCashRebate ? '4.' : '2.' }} {{ t('affiliate.tips.subscriptionBonus') }}</li>
              <li v-if="detail.aff_frozen_quota > 0">{{ hasCashRebate ? '5.' : '3.' }} {{ t('affiliate.tips.line4') }}</li>
            </ul>
          </div>
        </div>

        <div v-if="hasCashRebate || detail.aff_quota > 0 || detail.aff_history_quota > 0" class="card p-6">
...
const hasCashRebate = computed(() => (detail.value?.effective_rebate_rate_percent ?? 0) > 0)
